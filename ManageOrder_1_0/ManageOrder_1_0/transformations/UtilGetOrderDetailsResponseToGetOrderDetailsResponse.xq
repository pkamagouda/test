(:: pragma bea:global-element-parameter parameter="$utilGetOrderDetailsResponse" element="ns2:utilGetOrderDetailsResponse" location="../../NorthBoundInterfaces/utilgetorderdetailsdata_1_0.xsd" ::)
(:: pragma bea:global-element-return element="ns0:getOrderDetailsResponse" location="../../NorthBoundInterfaces/manageorderdata_1_0.xsd" ::)

(: # Date # 	# Version # 	# Author # 		# Change Description # :)
(: 07/09/2009 		1.0.0 		Sadiq 			Initial version :)
(: 26/04/2010 		1.0.1 		Amit Kumar		Removed the DateTime Conevrsions as TS (UtilGetOrderDetails) will do the conversions:)

declare namespace xf = "http://soa.o2.co.uk/ManageOrder_1_0/transformations/UtilGetOrderDetailsResponseToGetOrderDetailsResponse/";
...
declare namespace ns3 = "http://soa.o2.co.uk/pscommonpostpaydata_1";
declare namespace ns2 = "http://soa.o2.co.uk/postpay/utilgetorderdetailsdata_1";

declare function xf:UtilGetOrderDetailsResponseToGetOrderDetailsResponse($utilGetOrderDetailsResponse as element(ns2:utilGetOrderDetailsResponse),$configData as element(*))
    as element(ns0:getOrderDetailsResponse) {
    	let $segmentation := $configData/service-config-data/Segmentation[1],
       	    $customerTier := $configData/service-config-data/CustomerTier[1]
        return   
        <ns0:getOrderDetailsResponse>
        {
                    ...
                    return
                        <ns0:package>
                            ...
                            <ns0:vatReversalReceiptStatus>{ data($package/ns2:vatReversalReceiptRtatus) }</ns0:vatReversalReceiptStatus>
                            {
                                ...
                                let $categoryVal := $configData/service-config-data/ESMEOrderItemCategory
                                return
                                    <ns0:item>
                                        <ns0:orderLineKey>
                                        ...
                                        {
                                         if(data($item/ns2:insuranceProduct))then
                                            <ns0:insuranceProduct>
                                                    {
                                                     if(data($item/ns2:insuranceProduct/ns2:imei))then
                                                        <ns0:imei>{ data($item/ns2:insuranceProduct/ns2:imei) }</ns0:imei>
                                                     else ""
                                                    }
                                                    {
                                                     if(data($item/ns2:insuranceProduct/ns2:msisdn))then
                                                        <ns0:msisdn>{ replace(data($item/ns2:insuranceProduct/ns2:msisdn),"^0","44")}</ns0:msisdn>
                                                     else ""
                                                    }
                                                    {
                                                     if(data($item/ns2:insuranceProduct/ns2:startAssignedProductDate))then
                                                        <ns0:assignedProductStartDate>{ data($item/ns2:insuranceProduct/ns2:startAssignedProductDate)}</ns0:assignedProductStartDate>
                                                     else ""
                                                    }
                                                    {
                                                     if(data($item/ns2:insuranceProduct/ns2:endAssignedProductDate))then
                                                        <ns0:assignedProductEndDate>{data($item/ns2:insuranceProduct/ns2:endAssignedProductDate)}</ns0:assignedProductEndDate>
                                                     else ""
                                                    }
                                                    {
                                                     if(data($item/ns2:insuranceProduct/ns2:overridePrice))then
                                                        <ns0:overridePrice>
                                                                <ns0:assignedProductOverrideAmount>{ data($item/ns2:insuranceProduct/ns2:overridePrice/ns2:assignedProductOverrideAmount) }</ns0:assignedProductOverrideAmount>
                                                                <ns0:assignedProductOverridePeriod>{ data($item/ns2:insuranceProduct/ns2:overridePrice/ns2:assignedProductOverridePeriod) }</ns0:assignedProductOverridePeriod>
                                                            </ns0:overridePrice>
                                                     else "" 
                                                    }
                                                    <ns0:assignedProductBillingFreq>{ data($item/ns2:insuranceProduct/ns2:assignedProductBillingFreq) }</ns0:assignedProductBillingFreq>
                                                    <ns0:isCrossCharged>{ data($item/ns2:insuranceProduct/ns2:isCrossCharged) }</ns0:isCrossCharged>
                                                </ns0:insuranceProduct>
                                         else ""
                                        }
                                        {
                        ...
                        <ns0:basicAddress>
                            {
                             if(data($deliveryDetails/ns2:basic_address/@houseNameOrNumber))then
                                <ns0:houseNameOrNumber>{ data($deliveryDetails/ns2:basic_address/@houseNameOrNumber) }</ns0:houseNameOrNumber>
                             else ""
                            }
                            {
                             if(data($deliveryDetails/ns2:basic_address/@street))then
                                <ns0:street>{ data($deliveryDetails/ns2:basic_address/@street) }</ns0:street>
                             else ""
                            }
                            {
                             if(data($deliveryDetails/ns2:basic_address/@city))then
                                <ns0:city>{ data($deliveryDetails/ns2:basic_address/@city) }</ns0:city>
                             else ""
                            }
                            {
                             if(data($deliveryDetails/ns2:basic_address/@county))then
                                <ns0:county>{ data($deliveryDetails/ns2:basic_address/@county) }</ns0:county>
                             else "" 
                            }
                            {
                            if(data($deliveryDetails/ns2:basic_address/@country)=data($configData/service-config-data/CountryNamePolitical))then
                            <ns0:country>{ data($configData/service-config-data/CountryNameGeographical) }</ns0:country>
                            else ""
                            }
            ...
            {
             let $creditcheckinfo:= $utilGetOrderDetailsResponse/ns2:orderDetailsResponse/ns2:credit_check_info
             return
             if(data($creditcheckinfo))then
                <ns0:creditCheckInfo>
                        {
                         if(data($creditcheckinfo/ns2:previousAddress))then
                            <ns0:previousAddress>
                                    {
                                     if(data($creditcheckinfo/ns2:previousAddress/ns2:addressStatus))then
                                        <ns0:addressStatus>{ data($creditcheckinfo/ns2:previousAddress/ns2:addressStatus) }</ns0:addressStatus>
                                     else ""
                                    }
                                    <ns0:basicAddress>
                                        {
                                         if(data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@houseNameOrNumber))then
                                            <ns0:houseNameOrNumber>{ data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@houseNameOrNumber) }</ns0:houseNameOrNumber>
                                         else ""
                                        }
                                        {
                                         if(data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@street))then
                                            <ns0:street>{ data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@street) }</ns0:street>
                                         else ""
                                        }
                                        {
                                        if(data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@city))then
                                            <ns0:city>{ data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@city) }</ns0:city>
                                         else ""
                                        }
                                        {
                                         if(data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@county))then
                                            <ns0:county>{ data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@county) }</ns0:county>
                                         else "" 
                                        }
                                        {
                                         if(data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@country)=data($configData/service-config-data/CountryNamePolitical))then
                                         	<ns0:country>{ data($configData/service-config-data/CountryNameGeographical)}</ns0:country>
                                         else ""
                                        }
                                        <ns0:postCode>{ data($creditcheckinfo/ns2:previousAddress/ns2:basicAddress/@postCode) }</ns0:postCode>
                                    </ns0:basicAddress>
                                </ns0:previousAddress>
                         else "" 
                        }
                        <ns0:legalEntityAddress>
                            <ns0:legalEntityName>{ data($creditcheckinfo/ns2:legalEntityAddress/ns2:legalEntityName) }</ns0:legalEntityName>
                            <ns0:basicAddress>
                                {
                                 if(data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@houseNameOrNumber))then
                                    <ns0:houseNameOrNumber>{ data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@houseNameOrNumber) }</ns0:houseNameOrNumber>
                                 else ""
                                }
                                {
                                 if(data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@street))then
                                    <ns0:street>{ data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@street) }</ns0:street>
                                 else "" 
                                }
                                {
                                 if(data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@city))then
                                    <ns0:city>{ data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@city) }</ns0:city>
                                 else ""
                                }
                                {
                                 if(data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@county))then
                                    <ns0:county>{ data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@county) }</ns0:county>
                                 else ""
                                }
                                {
                                 if(data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@country)=data($configData/service-config-data/CountryNamePolitical))then
                                	<ns0:country>{ data($configData/service-config-data/CountryNameGeographical) }</ns0:country>
                                else ""
                                }
                                <ns0:postCode>{ data($creditcheckinfo/ns2:legalEntityAddress/ns2:basicAddress/@postCode) }</ns0:postCode>
                            </ns0:basicAddress>
                        </ns0:legalEntityAddress>
                        <ns0:creditCheckDetails>
                            {
                             if(data($creditcheckinfo/ns2:creditCheckDetails/ns2:status))then
                                <ns0:status>{ data($creditcheckinfo/ns2:creditCheckDetails/ns2:status) }</ns0:status>
                             else ""
                            }
                            {
                             if(data($creditcheckinfo/ns2:creditCheckDetails/ns2:vetNumber))then
                                <ns0:vetNumber>{ data($creditcheckinfo/ns2:creditCheckDetails/ns2:vetNumber) }</ns0:vetNumber>
                             else ""
                            }
                            {
                             if(data($creditcheckinfo/ns2:creditCheckDetails/ns2:score))then
                                <ns0:score>{ data($creditcheckinfo/ns2:creditCheckDetails/ns2:score) }</ns0:score>
                             else ""
                            }
                            {
                            if(data($creditcheckinfo/ns2:creditCheckDetails/ns2:lastCheckDate))then
                               <ns0:lastCheckDate>{ data($creditcheckinfo/ns2:creditCheckDetails/ns2:lastCheckDate) }</ns0:lastCheckDate>
                             else ""
                            }
                            {
                             if(data($creditcheckinfo/ns2:creditCheckDetails/ns2:creditClassId))then
                                <ns0:creditClassId>{ xs:integer( data($creditcheckinfo/ns2:creditCheckDetails/ns2:creditClassId) ) }</ns0:creditClassId>
                             else ""
                            }
                        </ns0:creditCheckDetails>
                    </ns0:creditCheckInfo>
...
xf:UtilGetOrderDetailsResponseToGetOrderDetailsResponse($utilGetOrderDetailsResponse,$configData)