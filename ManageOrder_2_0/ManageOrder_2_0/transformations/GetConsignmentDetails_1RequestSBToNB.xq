...
declare function xf:GetConsignmentDetails_1RequestSBToNB($utilGetConsignmentDetailsResp as element())
...
xf:GetConsignmentDetails_1RequestSBToNB($utilGetConsignmentDetailsResp)