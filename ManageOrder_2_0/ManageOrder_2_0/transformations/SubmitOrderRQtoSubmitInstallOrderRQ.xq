                                    ...
                                    }
                                    {
                                        ...
                                        return
                                            <ns1:customerProfile>
                                                ...
                                                {
                                                    if ( data( $customerProfile/ns0:acceptO2Marketing )) then
                                                        <ns1:acceptO2Marketing>{ data($customerProfile/ns0:acceptO2Marketing) }</ns1:acceptO2Marketing>
                                                  	else ""
                                                }
                                                {
                                                    if (data( $customerProfile/ns0:acceptOtherMarketing )) then
                                                        <ns1:acceptOtherMarketing>{ data($customerProfile/ns0:acceptOtherMarketing) }</ns1:acceptOtherMarketing>
                                                   	else ""
                                                }
                                                {
